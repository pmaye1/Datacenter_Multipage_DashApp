...
dash.register_page(__name__,path='/HOMO_CT_FTRAB')
...
dbc.Col([
    ...
    # row  1
    dbc.Row(
        [html.H1('Femur µCT Outcomes for Male & Female Global Homozygous KO Mice',
                        style={'color': 'black', 'fontSize': 25,'fontFamily': "Verdana","font-weight":"600",
                               'text-align':'center','margin-left':-50}),

        ],style={'height': 60, 'padding-bottom': 0, 'padding-top': 0, 'margin-bottom':0,'margin-right':-200},
    ),
    # row  2
    dbc.Row([
    #     dbc.Col([
    ...
    #     ]),
        dbc.Col([
            ...
            # },
            {'if': {
                'filter_query': '{Female Femur} >= 18.0',
                'column_id': 'Female Femur'},
            'backgroundColor': 'tomato',
            'color': 'white'
            },
            {'if': {
                'filter_query': '{Male Femur} >= 20.39',
        ...
        {
            'if': {
                'filter_query': '{Female Femur} <= -17.5',
                'column_id': 'Female Femur'},
            'backgroundColor': 'dodgerblue',
            'color': 'white',
         },
            {'if': {
                'filter_query': '{Male Femur} <= -21.5',
                'column_id': 'Male Femur'},
            'backgroundColor': 'dodgerblue',
            'color': 'white'
            },
        ...
        # dbc.Col([], width=1),
        dbc.Col([
            dcc.Graph(id='box_plot', config={'modeBarButtonsToRemove': ['pan2d', 'displaylogo','autoScale2d','resetScale2d','hoverClosestCartesian',
